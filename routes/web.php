...
Route::get('/xem-phim/{slug}/tap-{tap}', [IndexController::class, 'watch'])->name('watch');
Route::get('/tap-phim', [IndexController::class, 'episode'])->name('episode');
Route::get('/nam/{year}', [IndexController::class, 'year']);
Route::get('/tag/{tag}', [IndexController::class, 'tag']);

Route::get('/loc', [IndexController::class, 'loc'])->name('loc');
Route::get('/loc-phim', [IndexController::class, 'loc_phim'])->name('locphim');
